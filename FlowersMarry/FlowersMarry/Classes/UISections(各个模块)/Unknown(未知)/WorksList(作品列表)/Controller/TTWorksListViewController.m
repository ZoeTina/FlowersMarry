...
static NSString * const reuseIdentifier = @"TTWorksListViewController";

@interface TTWorksListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TTWorksListViewController
...
- (void) getComboListData{
    ...
    [SCHttpTools getWithURLString:@"zuo_pin/getlist" parameter:parameter success:^(id responseObject) {
        ...
        if (result) {
            ...
            BusinessCaseDataModel *caseData = [BusinessCaseDataModel mj_objectWithKeyValues:[result lz_objectForKey:@"data"]];
            [self.itemModelArray addObjectsFromArray:caseData.list];
        }
        [self analysisData];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FMWorksListTableViewCell *tools = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[FMWorksListTableViewCell class] forCellReuseIdentifier:reuseIdentifier];
