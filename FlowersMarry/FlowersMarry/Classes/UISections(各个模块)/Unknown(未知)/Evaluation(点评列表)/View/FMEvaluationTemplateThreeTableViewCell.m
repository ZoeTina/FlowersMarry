//
//  FMEvaluationTemplateThreeTableViewCell.m
//  FlowersMarry
//
...
@interface FMEvaluationTemplateThreeTableViewCell()<UICollectionViewDelegate,UICollectionViewDataSource>

@end
@implementation FMEvaluationTemplateThreeTableViewCell
...
- (void)setEvaluationModel:(BusinessComment *)evaluationModel{
    ...
    [self initView];
    [self initConstraint];
    [self.imagesView sd_setImageWithURL:kGetVideoURL(evaluationModel.avatar) placeholderImage:kGetImage(imagePlaceholder)];
    self.nicknameLabel.text = evaluationModel.user_name;
    self.datetimeLabel.text = evaluationModel.ct_add_time;
//    self.startRating.currentScore = [evaluationModel.ct_level floatValue];
    self.titleLabel.text = evaluationModel.ct_content;
