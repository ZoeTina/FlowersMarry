//
//  FMEvaluationTemplateTwoTableViewCell.h
//  FlowersMarry
//
...
@protocol FMEvaluationTemplateTwoTableViewCellDelegate <NSObject>
...
@end
@interface FMEvaluationTemplateTwoTableViewCell : UITableViewCell
/// 标题
...
@property (nonatomic, weak) id<FMEvaluationTemplateTwoTableViewCellDelegate> delegate;
