...
@implementation SCPlaybackControls
...
- (void)_showOrHideStatusBar
{
    switch (_statusBarHideState) {
        case SCStatusBarHideStateFollowControls: {
            [[UIApplication sharedApplication] setStatusBarHidden:!self.isShowing];
        }
            break;
        case SCStatusBarHideStateNever: {
            [[UIApplication sharedApplication] setStatusBarHidden:NO];
        }
            break;
        case SCStatusBarHideStateAlways: {
...
- (void)makeConstraints
{
    ...
    [_fullScreenButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.bottom.equalTo(self.bottomControlsBar);
    ...
    [_playTimeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(self.bottomControlsBar.mas_centerY);
    }];
...
- (UIButton *)playButton
{
    if (!_playButton){
        ...
        [_playButton setImage:[UIImage imageNamed:@"live_btn_play"] forState:UIControlStateNormal];
        [_playButton setImage:[UIImage imageNamed:@"live_btn_pause"] forState:UIControlStateSelected];
...
- (UIButton *)fullScreenButton{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"live_btn_fullscreen"] forState:UIControlStateNormal];
        [_fullScreenButton setImage:[UIImage imageNamed:@"live_btn_fullscreen"] forState:UIControlStateSelected];
...
/** 滑杆 */
- (SCVideoSlider *)videoSlider
{
    if (!_videoSlider) {
        _videoSlider = [[SCVideoSlider alloc]init];
