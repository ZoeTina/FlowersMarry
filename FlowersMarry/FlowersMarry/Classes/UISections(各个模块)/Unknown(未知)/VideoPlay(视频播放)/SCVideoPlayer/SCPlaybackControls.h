...
#import "SCVideoSlider.h"
#import "SCPlayerConfiguration.h"

/** 播放器控制面板代理 */
@protocol SCPlaybackControlsDelegate <NSObject>
...
@interface SCPlaybackControls : UIView
...
/** 进度滑杆 */
@property (nonatomic, strong) SCVideoSlider *videoSlider;
/** 播放时间 */
...
/** 播放器控制面板代理 */
@property (nonatomic, weak) id<SCPlaybackControlsDelegate> delegate;
/** 隐藏控制面板延时时间 缺省5s */
