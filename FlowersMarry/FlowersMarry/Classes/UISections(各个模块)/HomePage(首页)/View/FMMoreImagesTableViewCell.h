...
@interface FMMoreImagesTableViewCell : UITableViewCell
...
@property (strong, nonatomic) UIImageView *imagesViewTop;
@property (strong, nonatomic) UIImageView *imagesViewBottom;
/// 图片数量
