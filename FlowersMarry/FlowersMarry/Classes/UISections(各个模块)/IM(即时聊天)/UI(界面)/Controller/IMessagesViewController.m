...
@interface IMessagesViewController ()
@property (assign, nonatomic) BOOL isLoading;
@end

@implementation IMessagesViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return [IMessagesTableViewCell tableHeightWithModel:self.messageArray[indexPath.row]];
}
