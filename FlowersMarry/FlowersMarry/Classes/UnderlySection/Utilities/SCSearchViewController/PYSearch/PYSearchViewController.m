...
- (void)setup
{
    ...
    cancleButton.titleLabel.font = kFontSizeMedium15;
    [cancleButton setTitleColor:kTextColor102 forState:UIControlStateNormal];
    ...
    for (UIView *subView in [[searchBar.subviews lastObject] subviews]) {
        if ([[subView class] isSubclassOfClass:[UITextField class]]) {
            ...
            textField.textColor = kTextColor170;
            textField.tintColor = kTextColor170;
...
- (UILabel *)labelWithTitle:(NSString *)title
{
    ...
    label.font = kFontSizeMedium12;
    label.text = title;
    label.textColor = kColorWithRGB(34, 34, 34);
    label.backgroundColor = [UIColor lz_colorWithHexString:@"#F6F7FB"];
