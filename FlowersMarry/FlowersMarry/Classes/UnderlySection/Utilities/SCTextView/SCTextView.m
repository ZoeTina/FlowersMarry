...
#import "SCTextView.h"
#import "UITextView+SCExtension.h"
...
- (void)addConfig{
    ...
    self.maxNumState = SCMaxNumStateNormal;
...
- (void)setMaxNumState:(SCMaxNumState)maxNumState{
...
- (void)textViewDidChange:(UITextView *)textView{
    ...
    if (self.maxNumState == SCMaxNumStateNormal) {
