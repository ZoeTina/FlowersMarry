...
- (void)initSubViews {
    ...
    _panelBottomView = [[PanelBottomView alloc] init];
    _panelBottomView.frame = CGRectMake(0, CGRectGetMaxY(_scrollView.frame), self.frame.size.width, kFacePanelBottomToolBarHeight);
