...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_iconBtn.layer setCornerRadius:5.0f];
        [_iconBtn.layer setBorderWidth:kBorderWidth1px];
        [_iconBtn.layer setBorderColor:[UIColor grayColor].CGColor];
        [_iconBtn setBackgroundImage:[UIImage lz_imageWithColor:[UIColor colorWithWhite:0.5 alpha:0.3]] forState:UIControlStateHighlighted];
        [_iconBtn addTarget:self action:@selector(iconBtnClick:) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:_iconBtn];
        
        _nameLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_iconBtn.frame)+3, kMoreItemIconSize, kMoreItemH- kMoreItemIconSize)];
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _pageControl.pageIndicatorTintColor = kColorWithRGB(214, 214, 214);
        _pageControl.currentPageIndicatorTintColor = kColorWithRGB(139, 139, 139);
