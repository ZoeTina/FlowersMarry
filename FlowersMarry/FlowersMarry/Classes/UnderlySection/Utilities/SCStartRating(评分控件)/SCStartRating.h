...
typedef NS_ENUM(NSUInteger, SCRatingType) {
    SCRatingTypeWhole ,     // 整颗星星
    SCRatingTypeHalf ,      // 半颗星星
    SCRatingTypeUnlimited   // 无限制
};;

@interface SCStartRating : UIView
...
/** 评分类型 (初始化后设置 , 默认 SCRatingTypeWhole) */
@property (nonatomic , assign ) SCRatingType type;
