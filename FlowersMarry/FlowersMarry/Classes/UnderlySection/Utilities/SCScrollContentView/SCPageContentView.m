...
#import "SCPageContentView.h"

#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] floatValue])
static NSString *collectionCellIdentifier = @"collectionCellIdentifier";

@interface SCPageContentView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation SCPageContentView
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(SCContentViewWillBeginDragging:)]) {
        [self.delegate SCContentViewWillBeginDragging:self];
    }
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(SCContentViewDidScroll:startIndex:endIndex:progress:)]) {
        [self.delegate SCContentViewDidScroll:self startIndex:startIndex endIndex:endIndex progress:progress];
    }
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(SCContenViewDidEndDecelerating:startIndex:endIndex:)]) {
        [self.delegate SCContenViewDidEndDecelerating:self startIndex:startIndex endIndex:endIndex];
    }
}
