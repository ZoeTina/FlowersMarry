...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.menuViewStyle = MVMenuViewStyleLine;/// 样式
...
- (void) setupNavigationBarTheme {
    ...
    [self.navigationController.navigationBar setBackgroundImage:[[UIImage lz_imageWithColor:kColorWithRGB(253, 56, 98)] resizableImageWithCapInsets:UIEdgeInsetsMake(5, 1, 5, 1)] forBarMetrics:UIBarMetricsDefault];
